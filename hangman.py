...
def lose():
        ...
        temp.pendown()
        temp.write("This was the Country name:",align="left", font=("Arial", 30, "bold"))
...
turtle.goto(0,300)
turtle.color('white')
turtle.write("Hangman\nGuess the Country Name",align="left",font=("Serif",30))
turtle.hideturtle()
turtle.pendown()
